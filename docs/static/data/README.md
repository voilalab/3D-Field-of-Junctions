...
The controlled phantom is a large five-level polyhedron with intersecting
planes, a rotated void, an octahedral cavity, and orthogonal and oblique
channels. It is a visualization designed to make the
...
support. The displayed result uses hard membership in material levels estimated
